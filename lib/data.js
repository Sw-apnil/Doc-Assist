...
export const testimonials = [
  {
    ...
    role: "Patient",
    quote:
      "Booking an appointment on Doc Assist was so easy. I consulted a gynecologist online without waiting in long hospital queues.",
  },
  {
    initials: "DR",
    name: "Dr. Rohan Mehta",
    role: "Cardiologist",
    quote:
      "Doc Assist has transformed my practice. I can consult patients across India, especially in smaller towns where specialists are not easily available.",
  },
  {
    initials: "RS",
    name: "Ravi S.",
    role: "Patient",
    quote:
      "The credit system is very affordable. I purchased a package for my parents, and they can easily consult doctors from the comfort of home.",
  },
];
